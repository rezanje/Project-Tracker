...
/** The account level: every workspace at once. Rendered by Home whenever the
 *  scope is "Semua workspace" — it is not a route of its own, because it isn't
 *  a separate place. It is what Home means one level up. */
...
export default function CommandCenter({ d }: { d: DashboardData }) {
